            ...
            if paddle.pausec !=1:
                ...
                if not ball.bottom_hit:
                    ...
                    if ball.hit==95:
                        ...
                        canvas.create_text(250, 250, text="YOU WON, HURRAY !!", fill="yellow", font="Consolas 24 ")
                        root.update_idletasks()
                        root.update()
                        playing = False
                        break
